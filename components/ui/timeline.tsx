  ...
  return (
    ...
    >
      ...
      <div ref={ref} className="relative max-w-4xl mx-auto pb-20">
        {data.map((item, index) => (
          <div key={index} className="flex pt-10 md:pt-40 gap-0 md:gap-20">
            <div className="sticky flex flex-col md:flex-row z-10 items-center top-40 self-start w-16 sm:w-20 md:w-56 lg:w-64">
