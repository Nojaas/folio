  ...
  work: [
    {
      ...
      description:
        "Architecture et déploiement d'applications web complètes avec Next.js, Prisma et PostgreSQL. Conception d'API REST sécurisées avec authentification, RBAC, middlewares et validation de données via Zod. Conteneurisation Docker et automatisation CI/CD avec GitHub Actions. Optimisation des traitements lourds via des files d'attente asynchrones (Redis & BullMQ).",
    },
    {
      company: "Perfmaker",
      badges: [],
      ...
      technologies: ["React", "Typescript", "Node.js", "PostgreSQL", "CI/CD", "Notion", "GTM"],
      description:
        "Développement de l'application front-end en React et contribution au back-end. Mise en place de pipelines CI/CD pour automatiser les builds, tests et déploiements. Optimisation avancée des performances : amélioration des Core Web Vitals, mise en cache, CDN et Server-Side Rendering.",
    },
    {
      company: "Tylto",
      badges: [],
      ...
      description:
        "Conception et développement de la plateforme de digitalisation immobilière : gestion des documents, signatures électroniques, dashboards métiers complexes et statistiques.",
    },
  ],
